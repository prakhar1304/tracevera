              ...
              {transactionsData.map((transaction) => (
                <TableRow key={transaction.id}>
                  <TableCell>
                    <Badge
                      variant={
                        transaction.type === "labor" ? "default" : "secondary"
                      }
                    >
                      {transaction.type}
                    </Badge>
        ...
        <CardContent>
          <div className="w-full h-64 relative">
            <svg className="w-full h-full" viewBox="0 0 800 200">
              ...
              <text x="125" y="100" textAnchor="middle" className="text-xs">
                ${project.budget.toLocaleString()}
              </text>
              ...
              <text x="375" y="100" textAnchor="middle" className="text-xs">
                ${project.budget.toLocaleString()}
              </text>
              ...
              <text x="625" y="50" textAnchor="middle" className="text-xs">
              ...
              <text x="625" y="150" textAnchor="middle" className="text-xs">
